...
class NearEarthObject:
    ...
    def __str__(self):
        ...
        return f"A NearEarthObject({self.designation}, {self.name}, {self.diameter}, {self.isHazardous})"
...
class CloseApproach:
    ...
    # TODO: How can you, and should you, change the arguments to this constructor?
    # If you make changes, be sure to update the comments in this file.
    def __init__(self, designation, jd_time, distance, velocity, neo):
    ...
    def __str__(self):
        ...
        # The project instructions include one possibility. Peek at the __repr__
        # method for examples of advanced string formatting.
        return f"A CloseApproach ({self._designation}, {self.time}, {self.distance}, {self.velocity}, {self.neo})"
